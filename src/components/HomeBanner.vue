  ...
  <section>
    <div class="flex justify-between items-center">
      <div class="max-w-xl">
        ...
        <h2 class="mt-8 font-inter text-lg font-normal text-[#5B5F62]">
          Plan and book your perfect trip with expert advice, travel tips,
          destination information and inspiration from us.
        </h2>
        <div
          class="mt-11 flex items-center p-3 pl-7 border rounded-[38px]
          max-w-[500px] max-h-[76px] justify-between bg-white"
        >
          <div>
            ...
            <div class="flex items-center">
              ...
              <svg width="9" height="13" viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M9 4.55C9 3.95249 8.8836 3.36082 8.65746 2.80879C8.43131 2.25676 8.09984 1.75517 7.68198
                 1.33266C7.26412 0.910158 6.76804 0.575007 6.22208 0.346348C5.67611 0.117689 5.09095 0 4.5 0C3.90905
                 0 3.32389 0.117689 2.77792 0.346348C2.23196 0.575007 1.73588 0.910158 1.31802 1.33266C0.900156 1.75517
                 0.568688 2.25676 0.342542 2.80879C0.116396 3.36082 -8.80582e-09 3.95249 0 4.55C0 5.45155 0.263571 6.29005 0.710357 6.99725H0.705214C2.22236 9.399 4.5 13 4.5 13L8.29479 6.99725H8.29029C8.75341 6.26689 8.99971 5.41758 9 4.55ZM4.5 6.5C3.98851 6.5 3.49797 6.29455 3.13629 5.92886C2.77462 5.56316 2.57143 5.06717 2.57143 4.55C2.57143 4.03283 2.77462 3.53684 3.13629 3.17114C3.49797 2.80545 3.98851 2.6 4.5 2.6C5.01149 2.6 5.50203 2.80545 5.86371 3.17114C6.22538 3.53684 6.42857 4.03283 6.42857 4.55C6.42857 5.06717 6.22538 5.56316 5.86371 5.92886C5.50203 6.29455 5.01149 6.5 4.5 6.5Z" fill="#F66F4D"
                />
              </svg>
            </div>
          </div>
      ...
      <div class="min-w-[400px]">
        <img class="max-w-full max-h-full" src="@/static/Image(1).png" alt="downloading failed">
      </div>
    </div>
  </section>
</template>
